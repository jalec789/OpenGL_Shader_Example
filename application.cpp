...
GLuint loadShader(const char* vertexfilename, const char* fragmentfilename)
{
    ...
    string vertex_code = getTextFile(vertexfilename);
    string fragment_code = getTextFile(fragmentfilename);
    ...
    // You are provided with the function getTextFile to load a string from a text file (getTextFile() function)
